...
//For example, if the array is [1,6,7,8,3,4,5,6] and the number is 8, the output should be:
//3
var numbers = [1, 6, 7, 8, 3, 4, 5, 6]; //create an array of numbers
var index = numbers.indexOf(7); //find the index of the element equal to 6
